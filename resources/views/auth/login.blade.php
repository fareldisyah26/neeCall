        ...
        <div class="w-50 ms-5">
            ...
            <div class="p-5">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" class="btn btn-primary" style="background: linear-gradient(0deg, #FAE3B6, #FAE3B6); box-shadow: 0px 4px 4px 0px #00000040; border-radius: 20px; height: 60px; width: 472px; border-radius: 20px;">
