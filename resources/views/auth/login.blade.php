        ...
        <div class="w-50 ms-5">
            ...
            <div class="p-5">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus style="width: 472px; height: 60px; box-sizing: border-box; border: 1px solid #C5C5C5; border-radius: 20px;">
                    ...
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" style="width: 472px; height: 60px; box-sizing: border-box; border: 1px solid #C5C5C5; border-radius: 20px;">
                    ...
                    <button type="submit" class="btn btn-primary" style="background: linear-gradient(0deg, #739072, #739072); box-shadow: 0px 4px 4px 0px #00000040; border-radius: 20px; height: 60px; width: 472px; border-radius: 20px;">
                        <p class="pt-2 text-white"style="font-family: Frank Ruhl Libre; font-size: 24px; font-weight: 500; text-align: center;">LOGIN</p>
                    </button>
                    </div>

                    <h5 class="text-center mt-4">
                    <p style="font-family: Frank Ruhl Libre; font-size: 24px;font-weight: 500; line-height: 31px; letter-spacing: 0em; text-align: center;">Don't have an account? <a class="text-decoration-none text-primary" href="/register">Register Now!</a></h5>
