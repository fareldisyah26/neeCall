        ...
        <div class="text-center">
            <div class="d-inline-flex">
                <div class="card" style="width: 18rem;">
                    <img src="man/beach/IMG_1009.JPG" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="card ms-5" style="width: 18rem;">
                    <img src="man/college/IMG_0943.JPG" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="card ms-5" style="width: 18rem;">
                    <img src="man/summer/IMG_0962.JPG" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="card ms-5" style="width: 18rem;">
                    <img src="man/winter/IMG_0995.JPG" class="card-img-top" alt="...">
                    <div class="card-body">
